...
public class MainActivity extends AppCompatActivity {
    ...
    public void loginbutton(View view) {
        ...
        if (Patterns.EMAIL_ADDRESS.matcher(mail).matches() && password.length() > 8) {
            email.setError(null); pass.setError(null);
...
//                        ed.commit();
        ...
        else if (mail.isEmpty()){email.setError("please enter credentials"); email.requestFocus();}
        else if (password.isEmpty()){pass.setError("please enter credentials"); pass.requestFocus();}
    }
